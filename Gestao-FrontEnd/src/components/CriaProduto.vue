<template>
    <div class="modal-overlay" @click.self="$emit('close')">
        <div class="modal-container">
            <h2 class="titulo">Criar Nova Receita</h2>
            ...
            <form @submit.prevent="submitTicket">
                <div class="form-group">
                    <label for="cliente">Nome da categoria:</label>
                    <input type="text" id="categoria" placeholder="Nome da categoria">
                </div>

                <div class="form-group">
                    <label for="observacoes">Ingredientes:</label>
                    <textarea id="observacoes" rows="3" placeholder="Adicione os Ingredientes"></textarea>
                </div>
